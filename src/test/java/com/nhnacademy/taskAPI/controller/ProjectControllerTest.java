...
class ProjectControllerTest {
    ...
    class CreateProjectTests {
        ...
        void createProject_ValidationFailed() throws Exception {
            ProjectCreateRequestDto badDto = new ProjectCreateRequestDto(null); // @NotBlank 위반

            mockMvc.perform(post("/projects")
                            .header("X-USER-ID", adminId)
                            .contentType(MediaType.APPLICATION_JSON)
                            .accept(MediaType.APPLICATION_JSON) // 에러 응답도 JSON으로 받기
    ...
    class UpdateProjectTests {
        ...
        void updateProject_Success() throws Exception {
            Map<String, Object> requestMap = Map.of("name", "Updated", "status", "HIBERNATE");
        ...
        void updateProject_ValidationFailed() throws Exception {
            Map<String, Object> badRequestMap = Map.of("name", ""); // @NotBlank 위반
    ...
    @Nested
    @DisplayName("PATCH /projects/{projectId}/status (프로젝트 상태 변경)")
